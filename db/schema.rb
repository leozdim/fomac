...
ActiveRecord::Schema.define(version: 20180101171751) do
  ...
  create_table "art_activities", force: :cascade do |t|
  ...
  create_table "dance_evidences", force: :cascade do |t|
    t.bigint "project_id"
    t.string "web"
    t.string "video"
    t.text "image"
  ...
  create_table "film_evidences", force: :cascade do |t|
    t.bigint "project_id"
    t.string "web"
    t.string "video"
    t.string "demo"
  ...
  create_table "letter_evidences", force: :cascade do |t|
    t.bigint "project_id"
    t.string "web"
    t.string "work"
    t.text "cover"
  ...
  create_table "music_evidences", force: :cascade do |t|
    t.bigint "project_id"
    t.string "web"
    t.string "video"
    t.string "audio"
  ...
  create_table "retributions", force: :cascade do |t|
    t.bigint "project_id"
    t.bigint "modality_id"
  ...
  create_table "theater_evidences", force: :cascade do |t|
    t.bigint "project_id"
    t.string "web"
    t.string "video"
    t.string "letter"
  ...
  create_table "visual_evidences", force: :cascade do |t|
    t.bigint "project_id"
    t.text "catalog"
    t.text "image"
    t.text "note"
